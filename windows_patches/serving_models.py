...
class OpenAIModelRegistry:
    ...
    def is_base_model(self, model_name: str) -> bool:
        # devnen fork: hardwired wildcard. Single-tenant single-model deployments
        # don't need clients to match --served-model-name. LoRA path is unaffected
        # because _check_model consults the lora_requests dict before falling
        # through to is_base_model.
        return True
