...
def get_open_zmq_ipc_path() -> str:
    # Windows: ZMQ ipc:// transport is unsupported by pyzmq on Windows.
    # Fall back to a tcp:// loopback URL so the vLLM v1 EngineCore <->
    # APIServer <-> Worker channels can still bind.
    if os.name == "nt":
