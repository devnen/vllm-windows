...
class WorkerProc:
    ...
    def wait_for_ready(
        ...
        while pipes:
            ...
            for pipe in ready:
                # Windows returns PipeConnection here, POSIX returns Connection.
                # Both subclass _ConnectionBase. Widen the type guard so PP=2
                # (and any other multiproc executor path) works on Windows.
